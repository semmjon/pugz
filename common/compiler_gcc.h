 ...
 */
#define COMPILER_SUPPORTS_TARGET_FUNCTION_ATTRIBUTE (GCC_PREREQ(4, 4) || __has_attribute(target))
#if COMPILER_SUPPORTS_TARGET_FUNCTION_ATTRIBUTE
#    define COMPILER_SUPPORTS_TARGET_INTRINSICS (GCC_PREREQ(4, 9) || CLANG_PREREQ(3, 8, 7030000))
#    define COMPILER_SUPPORTS_PCLMUL_TARGET (GCC_PREREQ(4, 4) || __has_builtin(__builtin_ia32_pclmulqdq128))
#    define COMPILER_SUPPORTS_AVX_TARGET (GCC_PREREQ(4, 6) || __has_builtin(__builtin_ia32_maxps256))
#    define COMPILER_SUPPORTS_BMI2_TARGET (GCC_PREREQ(4, 7) || __has_builtin(__builtin_ia32_pdep_di))
#    define COMPILER_SUPPORTS_AVX2_TARGET (GCC_PREREQ(4, 7) || __has_builtin(__builtin_ia32_pmaddwd256))
#endif
...
#define DEFINE_UNALIGNED_TYPE(type)                                                                                                                            \
    ...
    {                                                                                                                                                          \
        type v;                                                                                                                                                \
                                                                                                                                                               ...
                                                                                                                                                               \
    static forceinline type load_##type##_unaligned(const void* p) { return static_cast<const struct type##unaligned*>(p)->v; }                                \
                                                                                                                                                               \
    static forceinline void store_##type##_unaligned(type v, void* p) { static_cast<struct type##unaligned*>(p)->v = v; }
